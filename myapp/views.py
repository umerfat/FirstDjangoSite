...
def index(request):
    ...
    # Creating context to pass book_list to index template
    context = {
        'book_list':book_list
    }
...
def detail(request, book_id):
    ...
    return render(request, 'myapp/detail.html', {'book':book}) #another way of creating context
...
def deleteBook(request, book_id):
    if request.method == "POST":
        ...
        book.delete()
        return redirect('/')
    return render(request, 'myapp/delete_book.html')
